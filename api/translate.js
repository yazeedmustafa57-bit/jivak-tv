...
function detectSourceLang(title) {
  ...
  // Deutsche Wörter erkennen auch ohne Umlaute – erweiterte Liste
  // Prüft Titel UND ilk 200 Zeichen des Textes für bessere Erkennung
  const lower = s.toLowerCase()
  if (/\b(politik|nachricht|nachrichten|region|wirtschaft|wirtschaftsbericht|wirtschaftliche|wirtschaftlich|kultur|sport|bildung|gesundheit|wissenschaft|technik|umwelt|klima|energie|verkehr|justiz|innenpolitik|außenpolitik|gesellschaft|geschichte|religion|tradition|identität|gemeinschaft|familie|kinder|jugend|senioren|frauen|menschen|flüchtlinge|integration|migration|diaspora|heimat|osten|westen|norden|süden|nahen|fernen|irak|syrien|iran|türkei|europa|deutschland|österreich|schweiz|berlin|bagdad|erbil|duhok|mosul|kirkuk|sulaimaniya|vorstand|herbst|sommer|frühling|winter|montag|dienstag|mittwoch|donnerstag|freitag|samstag|sonntag|januar|februar|märz|april|mai|juni|juli|august|september|oktober|november|dezember|jahr|jahre|monat|monate|woche|wochen|tag|tage|stunde|stunden|minute|minuten|male|prozent|millionen|milliarden|euro|dollar|dinar|preis|preise|kosten|markt|märkte|börse|aktien|wachstum|recession|inflation|zinsen|steuern|haushalt|budget|schuld|kredit|investition|produktion|export|import|handel|industrie|landwirtschaft|dienstleistung|arbeit|arbeitsmarkt|arbeitslosigkeit|lohn|gehalt|einkommen|vermögen|armut|sozial|rente|versicherung|gesundheit|krankheit|krankenhaus|arzt|medikament|impfung|pandemie|virus|bakterien|forschung|studie|ergebnis|entdeckung|erfindung|technologie|digitalisierung|internet|smartphone|computer|künstliche.intelligenz|roboter|automatisierung|energie|erneuerbar|kohle|gas|öl|strom|netz|preis|klimawandel|umwelt|natur|wald|meer|ozean|tier|pflanze|art|aussterben|biodiversität|nachhaltigkeit|recycling|abfall|verschmutzung|lufthygiene|wasserqualität|boden|landwirtschaft|ernährung|lebensmittel|organic|vegan|vegetarisch|fleisch|milch|brot|getreide|reis|nudel|kartoffel|gemüse|obst|salat|suppe|soße|gewürz|salz|pfeffer|zucker|honig|schokolade|kaffee|tee|bier|wein|wasser|saft|limonade|limonade|cocktail|drink|restaurant|café|bar|kneipe|kantine|mensa|buffet|party|feiertag|geburtstag|hochzeit|trauung|begräbnis|beerdigung|gedenkfeier|gedenktag|jubiläum|jubiläen|fest|festival|konzert|theater|kino|museum|ausstellung|galerie|bibliothek|schule|universität|hochschule|institut|akademie|lehre|unterricht|stunde|stunden|prüfung|test|klausur|arbeit|referat|vortrag|seminar|workshop|fortbildung|weiterbildung|zertifikat|diplom|abschluss|studium|forschung|projekt|plan|ziel|zielsetzung|strategie|maßnahme|aktionsplan|programm|initiative|kampagne|bewegung|partei|vereinigung|verband|organisation|institution|behörde|ministerium|amt|gericht|polizei|militär|armee|soldat|krieg|frieden|konflikt|krise|katastrophe|unfall|brand|flut|erdbeben|sturm|tornado|hochwasser|dürre|hitze|kälte|frost|schnee|regen|wind|wetter|klima)\b/i.test(lower)) return 'de'
  return 'en'
}
